(* Generated by generator.ml 2026-09-26T19:53:05Z *)
...
[
 Dream.post "/contests" Judge.postJudgeContests;
 Dream.put "/contests/:id" Judge.putJudgeContestsId;
 Dream.delete "/contests/:id" Judge.deleteJudgeContestsId;
]
